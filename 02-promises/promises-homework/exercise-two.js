...
function problemA() {
  ...
  // promise version
  const p1 = promisifiedReadFile("poem-two/stanza-01.txt").then((stanza1) =>
    blue(stanza1)
  );

  const p2 = promisifiedReadFile("poem-two/stanza-02.txt").then((stanza2) =>
    blue(stanza2)
  );
...
function problemB() {
  ...
  // promiseArray = [promisifiedReadFile(1).then(stanza => blue(stanza), promisifiedReadFile(2).then(stanza => blue(stanza), promisifiedReadFile(3).then(stanza => blue(stanza), etc]
