...
function problemD() {
  ...
  //IMPORTANTE
  // promisifiedReadFile('poem-one/wrong-file-name.txt')
  // Si yo tengo errorHandler definido aca esta promesa se va a resolver o rechazar
  // de acuerdo a lo que tenga, si por ejemplo retorno un 'hola' la proxima promesa
  // se va resolver a 'hola'
  // .then(stanza4 => blue(stanza4), (err) => {return 'hola'})
  // Sin embargo si pongo un 'throw error' la proxima promesa es rechazada ante ese erorr.
  // .then(stanza4 => blue(stanza4), (err) => {throw err})
}
